 ...
 */
export class MacroBrokenLinkError extends MacroExecutionError {
  private macroSource: any;
...
export class MacroWrongXRefError extends MacroBrokenLinkError {
  constructor(error, source, token) {
 ...
 */
export class MacroDeprecatedError extends MacroExecutionError {
  private macroSource;
 ...
 */
export class MacroLiveSampleError extends MacroExecutionError {
  private macroSource;
 ...
 */
export class MacroPagesError extends MacroExecutionError {
  private macroSource;
